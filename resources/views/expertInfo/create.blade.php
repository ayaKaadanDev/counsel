<x-app-layout>
    ...
    <div class="shadow border d-flex flex-column m-0 mx-auto mt-4" style="width:100%; max-width:30rem;">
        <div class="p-5">
          <div class="mt-4 mb-5">
            <h4 class="h2 font-weight-bold" style="color: #B99671">creating my information</h4>
          </div>
          <form action="{{route('expert_infos.store')}}" method="POST">
          @csrf
          ...
          <div class="cdb-form">
            ...
            {{-- <label for="photo" class="text-muted m-0">
                photo
              </label>
              <div class="cdb-form">
            ...
            <label for="expertness" class="text-muted m-0">
              ...
              <div class="cdb-form">
                <input type="text-area" class="form-control" name="expertness" required/>
              </div>
